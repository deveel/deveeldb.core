...
namespace Deveel.Data.Indexes {
	/// <summary>
	/// A block contained in a <see cref="BlockIndex{TKey, TValue}"/>.
	/// </summary>
	/// <remarks>
	/// This exposes the contents of a block of the list.
	/// <para>
	/// An <see cref="BlockIndexBase{TKey,TValue}"/> is a single element of a block of 
	...
	public interface IIndexBlock<TKey, TValue> : IEnumerable<TValue> {
		/// <summary>
		/// Gets or sets the next block in the hash.
		/// </summary>
		IIndexBlock<TKey, TValue> Next { get; set; }

		/// <summary>
		/// Gets or sets the previous block in the hash.
		/// </summary>
		IIndexBlock<TKey, TValue> Previous { get; set; }
		...
		/// </remarks>
		void MoveTo(IIndexBlock<TKey, TValue> destBlock, long destIndex, long count);
		...
		/// </remarks>
		void CopyTo(IIndexBlock<TKey, TValue> destBlock);
		...
		/// </remarks>
		///<returns></returns>
		long BinarySearch(TKey key, IIndexComparer<TKey, TValue> comparer);
